        ...
        <div className='pt-20 pb-16 px-8 flex flex-col md:flex-row items-center gap-8 relative z-20'>
          ...
          <div className='flex flex-col justify-end space-y-4'>
            ...
            <div className=' hidden md:flex items-center max-md:justify-center gap-6 pt-6'>
              <button
                className='bg-green-500 hover:bg-green-400 hover:scale-110 text-black font-bold rounded-full flex items-center justify-center w-13 h-13 md:w-14 md:h-14 transition-all duration-300 shadow-lg hover:shadow-green-500/25'
                    ...
                    {isCurrentTrackPlaying(track.encodeId) ? (
                      isShown === track.encodeId ? (
                        ...
                        <div className='loading-wave flex gap-[2px] h-4 items-end'>
                          <div className='loading-bar w-[2px] h-[2px] bg-green-500 rounded-full animate-bounce'></div>
                          <div className='loading-bar w-[2px] h-[3px] bg-green-500 rounded-full animate-bounce delay-100'></div>
                          <div className='loading-bar w-[2px] h-[2px] bg-green-500 rounded-full animate-bounce delay-200'></div>
                        </div>
                      )
                    ) : isShown === track.encodeId ? (
                ...
                <div className='col-span-2 text-right hidden'>
                  <div className='flex items-center justify-end gap-4'>
                    <button className='opacity-0 group-hover:opacity-100 transition-opacity'>
                      <Icon name='heart' className='text-gray-400 hover:text-green-400 text-lg' />
                    </button>
